...
def build_segmented_hinge(desired_width,desired_segment_length,desired_gap,num_layers):
...
#hinge = build_segmented_hinge(1,.05,.2,1)<<.01
...
l1 = idealab_tools.text_to_polygons.text_to_polygons('Layer 1',prop={'family':'Arial','size':5})
l2 = idealab_tools.text_to_polygons.text_to_polygons('Layer 2',prop={'family':'Arial','size':5})
l3 = idealab_tools.text_to_polygons.text_to_polygons('Layer 3',prop={'family':'Arial','size':5})
l4 = idealab_tools.text_to_polygons.text_to_polygons('Layer 4',prop={'family':'Arial','size':5})
l5 = idealab_tools.text_to_polygons.text_to_polygons('Layer 5',prop={'family':'Arial','size':5})
...
l1 = polys_to_layer(l1)
l2 = polys_to_layer(l2)
l3 = polys_to_layer(l3)
l4 = polys_to_layer(l4)
l5 = polys_to_layer(l5)

layer_id = Laminate(l1,l2,l3,l4,l5)
