...
#define NEW_ID 4 //New ID to be changed.
...
void loop() {
  position=Dxl.readWord(NEW_ID, GOAL_POSITION); //Compatible with all dynamixel serise
  SerialUSB.println(position);//SerialUSB.print("\r\n");  
  delay(100);
}
